...
<div class="max-w-6xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <!-- Header dengan info box orange -->
        <div class="px-6 py-4 border-b border-gray-200">
            <h1 class="text-xl md:text-2xl font-semibold text-gray-900 mb-2 pb-2 border-b-5 border-blue-900 inline-block">Sertifikat Pendidikan Karakter</h1>
            <div class="flex items-center bg-orange-50 border border-orange-200 rounded-lg px-4 py-3">
        ...
        <!-- Form -->
        <form id="form-pendidikan-karakter" action="{{ route('mahasiswa.sertifikat.pendidikan-karakter.store') }}" method="POST" class="p-6">
            @csrf
            
            <div id="sertifikat-container" class="space-y-6">
                @if($sertifikatPendidikanKarakter->count() > 0)
                    @foreach($sertifikatPendidikanKarakter as $index => $sertifikat)
                    <div class="sertifikat-item border border-gray-200 rounded-lg p-6 relative">
                        <!-- Tombol Hapus di pojok kanan atas -->
                        @if($sertifikatPendidikanKarakter->count() > 1)
                        ...
                        <!-- Form fields dalam satu baris grid -->
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Nama Sertifikat</label>
                                <input type="text" name="sertifikat_pendidikan_karakter[{{$index}}][nama_sertifikat]" 
                            ...
                            <div>
                                ...
                                <input type="text" name="sertifikat_pendidikan_karakter[{{$index}}][penerbit]" 
                            ...
                            <div>
                                ...
                                <input type="date" name="sertifikat_pendidikan_karakter[{{$index}}][tanggal_terbit]" 
                ...
                @else
                    <div class="sertifikat-item border border-gray-200 rounded-lg p-6 relative">
                        <!-- Tombol Hapus hidden untuk item pertama -->
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Nama Sertifikat</label>
                                <input type="text" name="sertifikat_pendidikan_karakter[0][nama_sertifikat]" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                                       placeholder="Contoh: Sertifikat Leadership" required>
                            </div>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Penerbit</label>
                                <input type="text" name="sertifikat_pendidikan_karakter[0][penerbit]" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                                       placeholder="Contoh: Universitas Wahid Hasyim" required>
                            </div>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Tanggal Terbit</label>
                                <input type="date" name="sertifikat_pendidikan_karakter[0][tanggal_terbit]" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Action Buttons - Tombol Simpan di kanan -->
...
<script>
    (function() {
        ...
        let sertifikatCount = {{ $sertifikatPendidikanKarakter->count() ?: 1 }};
        ...
        function addSertifikat() {
            ...
            newItem.innerHTML = `
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Nama Sertifikat</label>
                        <input type="text" name="sertifikat_pendidikan_karakter[${sertifikatCount}][nama_sertifikat]" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                               placeholder="Contoh: Sertifikat Leadership" required>
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Penerbit</label>
                        <input type="text" name="sertifikat_pendidikan_karakter[${sertifikatCount}][penerbit]" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                               placeholder="Contoh: Universitas Wahid Hasyim" required>
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Tanggal Terbit</label>
                        <input type="date" name="sertifikat_pendidikan_karakter[${sertifikatCount}][tanggal_terbit]" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                    </div>
                </div>
            `;

...
<div class="max-w-6xl mx-auto">
    ...
    <form action="{{ route('mahasiswa.sertifikat.magang.store') }}" method="POST">
        @csrf
        <div class="bg-gray-40 rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
            <h2 class="text-xl md:text-2xl font-semibold text-gray-900 mb-6">Sertifikat Magang</h2>
                    ...
                    <div class="sertifikat-entry p-8 bg-white border border-gray-200 rounded-lg relative transition-shadow duration-200 hover:shadow-md">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama_sertifikat[]" id="nama_sertifikat_{{ $loop->index }}" value="{{ old('nama_sertifikat.' . $loop->index, $sertifikat->nama_sertifikat) }}" placeholder="Contoh: Sertifikat Magang MSIB" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3" required>
                            </div>
                            <div>
                                <label for="penerbit_{{ $loop->index }}" class="block text-sm font-medium text-gray-700 mb-1">Penerbit</label>
                                <input type="text" name="penerbit[]" id="penerbit_{{ $loop->index }}" value="{{ old('penerbit.' . $loop->index, $sertifikat->penerbit) }}" placeholder="Contoh: Kemenristekdikti" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3" required>
                            </div>
                            <div class="relative">
                    ...
                    <div class="sertifikat-entry p-8 bg-white border border-gray-200 rounded-lg relative transition-shadow duration-200 hover:shadow-md">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama_sertifikat[]" id="nama_sertifikat_1" value="{{ old('nama_sertifikat.0') }}" placeholder="Contoh: Sertifikat Magang MSIB" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3" required>
                            </div>
                            <div>
                                <label for="penerbit_1" class="block text-sm font-medium text-gray-700 mb-1">Penerbit</label>
                                <input type="text" name="penerbit[]" id="penerbit_1" value="{{ old('penerbit.0') }}" placeholder="Contoh: Kemenristekdikti" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3" required>
                            </div>
                            <div class="relative">
            ...
            const newEntryHtml = `
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="nama_sertifikat[]" id="nama_sertifikat_${sertifikatCount}" placeholder="Contoh: Sertifikat Magang MSIB" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3" required>
                    </div>
                    <div>
                        <label for="penerbit_${sertifikatCount}" class="block text-sm font-medium text-gray-700 mb-1">Penerbit</label>
                        <input type="text" name="penerbit[]" id="penerbit_${sertifikatCount}" placeholder="Contoh: Kemenristekdikti" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3" required>
                    </div>
                    <div class="relative">

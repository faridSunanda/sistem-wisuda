                    ...
                    <div class="sertifikat-entry p-8 bg-white border border-gray-200 rounded-lg relative transition-shadow duration-200 hover:shadow-md">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama_sertifikat[]" id="nama_sertifikat_{{ $loop->index }}" value="{{ old('nama_sertifikat.' . $loop->index, $sertifikat->nama_sertifikat) }}" placeholder="Contoh: Sertifikat Magang MSIB" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#435ebe] focus:border-transparent" required>
                            </div>
                            <div>
                                <label for="penerbit_{{ $loop->index }}" class="block text-sm font-medium text-gray-700 mb-1">Penerbit</label>
                                
                                <input type="text" name="penerbit[]" id="penerbit_{{ $loop->index }}" value="{{ old('penerbit.' . $loop->index, $sertifikat->penerbit) }}" placeholder="Contoh: Kemenristekdikti" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#435ebe] focus:border-transparent" required>
                            </div>
                            <div class="relative">
                    ...
                    <div class="sertifikat-entry p-8 bg-white border border-gray-200 rounded-lg relative transition-shadow duration-200 hover:shadow-md">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama_sertifikat[]" id="nama_sertifikat_1" value="{{ old('nama_sertifikat.0') }}" placeholder="Contoh: Sertifikat Magang MSIB" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#435ebe] focus:border-transparent" required>
                            </div>
                            <div>
                                <label for="penerbit_1" class="block text-sm font-medium text-gray-700 mb-1">Penerbit</label>
                                
                                <input type="text" name="penerbit[]" id="penerbit_1" value="{{ old('penerbit.0') }}" placeholder="Contoh: Kemenristekdikti" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#435ebe] focus:border-transparent" required>
                            </div>
                            <div class="relative">
...
@push('scripts')
    @vite('resources/js/mahasiswa/sertifikat/sertifikat-magang/index.js')
@endpush
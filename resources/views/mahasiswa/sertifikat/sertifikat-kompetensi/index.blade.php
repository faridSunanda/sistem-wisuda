...
<div class="max-w-6xl mx-auto">
    ...
    <form action="{{ route('mahasiswa.sertifikat.kompetensi.store') }}" method="POST">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
            ...
            <h2 class="text-xl md:text-2xl font-semibold text-gray-900 mb-6 pb-2 border-b-4 border-[#435ebe] inline-block">Sertifikat Kompetensi</h2>
...
@push('scripts')
    @vite('resources/js/mahasiswa/sertifikat/sertifikat-kompetensi/index.js')
@endpush
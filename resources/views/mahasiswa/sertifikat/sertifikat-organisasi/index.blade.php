                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_mulai[]" 
                                       value="{{ old('tanggal_mulai.' . $index, $sertifikat->tanggal_mulai->format('Y-m-d')) }}" 
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_selesai[]" 
                                       value="{{ old('tanggal_selesai.' . $index, $sertifikat->tanggal_selesai->format('Y-m-d')) }}" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#435ebe] focus:border-transparent" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sertifikat-entry p-8 bg-white border border-gray-200 rounded-lg relative transition-shadow duration-200 hover:shadow-md">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_mulai[]" value="{{ old('tanggal_mulai.0') }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#435ebe] focus:border-transparent" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_selesai[]" value="{{ old('tanggal_selesai.0') }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#435ebe] focus:border-transparent" required>
                            </div>
                        </div>
                    </div>

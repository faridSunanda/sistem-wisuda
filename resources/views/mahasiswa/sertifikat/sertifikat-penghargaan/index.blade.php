...
@section('content')
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
            ...
            <div class="space-y-4">
                <div class="text-center py-8 md:py-12 text-gray-500">
                    <p class="text-sm md:text-base">Halaman Sertifikat Penghargaan</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <form id="form-penghargaan" action="{{ route('mahasiswa.sertifikat.penghargaan.store') }}" method="POST" class="p-6">
        ...
        <div id="sertifikat-container" class="space-y-6">
            @if ($sertifikatPenghargaans->count() > 0)
                @foreach ($sertifikatPenghargaans as $index => $sertifikat)
                    <div class="sertifikat-item border border-gray-200 rounded-lg p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-medium text-gray-900">Sertifikat Penghargaan</h3>
                            @if ($sertifikatPenghargaans->count() > 1)
                                <button type="button"
                                    class="remove-sertifikat text-red-600 hover:text-red-700 text-sm font-medium flex items-center">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="sertifikat_penghargaan[{{ $index }}][nama_sertifikat]"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="sertifikat_penghargaan[{{ $index }}][penerbit]"
                                ...
                                <div>
                                    ...
                                    <input type="date" name="sertifikat_penghargaan[{{ $index }}][tanggal_terbit]"
            ...
            @else
                <div class="sertifikat-item border border-gray-200 rounded-lg p-6">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-medium text-gray-900">Sertifikat Penghargaan</h3>
                        <button type="button"
                            class="remove-sertifikat text-red-600 hover:text-red-700 text-sm font-medium flex items-center opacity-0 pointer-events-none">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16">
                                </path>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Nama Sertifikat</label>
                            <input type="text" name="sertifikat_penghargaan[0][nama_sertifikat]"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                placeholder="Contoh: Juara 1 Lomba Programming" required>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Penerbit</label>
                                <input type="text" name="sertifikat_penghargaan[0][penerbit]"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    placeholder="Contoh: Universitas Wahid Hasyim" required>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Tanggal Terbit</label>
                                <input type="date" name="sertifikat_penghargaan[0][tanggal_terbit]"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    required>
                            </div>
                        </div>
...
@push('scripts')
    <script>
        (function() {
            ...
            let sertifikatCount = {{ $sertifikatPenghargaans->count() ?: 1 }};
            ...
            function updateRemoveButtons() {
                ...
                items.forEach((item, index) => {
                    ...
                    title.textContent = `Sertifikat Penghargaan ${index + 1}`;
            ...
            function addSertifikat() {
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Nama Sertifikat</label>
                        <input type="text" name="sertifikat_penghargaan[${sertifikatCount}][nama_sertifikat]" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                               placeholder="Contoh: Juara 1 Lomba Programming" required>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Penerbit</label>
                            <input type="text" name="sertifikat_penghargaan[${sertifikatCount}][penerbit]" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                                   placeholder="Contoh: Universitas Wahid Hasyim" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Tanggal Terbit</label>
                            <input type="date" name="sertifikat_penghargaan[${sertifikatCount}][tanggal_terbit]" 

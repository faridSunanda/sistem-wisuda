...
<div class="max-w-6xl mx-auto">
    ...
    <form action="{{ route('mahasiswa.sertifikat.penghargaan.store') }}" method="POST">
        @csrf
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
            

            <h2 class="text-xl md:text-2xl font-semibold text-gray-900 mb-6 pb-2 border-b-4 border-[#435ebe] inline-block">Sertifikat Penghargaan</h2>
...
@push('scripts')
    @vite('resources/js/mahasiswa/sertifikat/sertifikat-penghargaan/index.js')
@endpush
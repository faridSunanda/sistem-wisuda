...
@section('content')
    <div class="space-y-4 md:space-y-6 pb-10">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
            ...
            <form action="{{ route('akademik.data-wisudawan.update', $biodata->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                    ...
                    <div class="md:col-span-2 border-b border-gray-100 pb-2 mb-2">
                        <h3 class="text-sm font-semibold text-[#435ebe] uppercase tracking-wider">Data Akun</h3>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="name_lengkap" name="name_lengkap"
                            value="{{ old('name_lengkap', $biodata->user->name_lengkap) }}" required
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" 
                            value="{{ old('email', $biodata->user->email) }}" required
                            class="w-full px-4 py-2.5 text-sm bg-gray-50 border-0 rounded-lg text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-[#435ebe] focus:bg-white transition-all">
                    </div>

                    <div class="md:col-span-2 border-b border-gray-100 pb-2 mb-2 mt-4">
                        <h3 class="text-sm font-semibold text-[#435ebe] uppercase tracking-wider">Data Akademik</h3>
                    </div>

                    <div>
                        <label for="nim" class="block text-sm font-normal text-gray-600 mb-1.5">NIM</label>
                        <input type="text" id="nim" name="nim"
                            value="{{ old('nim', $biodata->nim) }}"
                            class="w-full px-4 py-2.5 text-sm bg-gray-50 border-0 rounded-lg text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-[#435ebe] focus:bg-white transition-all">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="tahun_masuk" name="tahun_masuk"
                            value="{{ old('tahun_masuk', $biodata->tahun_masuk) }}"
                            class="w-full px-4 py-2.5 text-sm bg-gray-50 border-0 rounded-lg text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-[#435ebe] focus:bg-white transition-all">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="fakultas" name="fakultas"
                            value="{{ old('fakultas', $biodata->fakultas) }}"
                            class="w-full px-4 py-2.5 text-sm bg-gray-50 border-0 rounded-lg text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-[#435ebe] focus:bg-white transition-all">
                    </div>

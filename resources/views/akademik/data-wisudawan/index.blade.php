...
@push('styles')
    ...
    @vite('resources/css/akademik/data-wisudawan.css')
@endpush
...
@push('scripts')
    ...
    <script>
        window.dataWisudawanConfig = {
            getDataUrl: "{{ route('akademik.data-wisudawan.get-data') }}",
            exportUrl: "{{ route('akademik.data-wisudawan.export') }}",
            exportExcelUrl: "{{ route('akademik.data-wisudawan.export-excel') }}",
            exportPdfUrl: "{{ route('akademik.data-wisudawan.export-pdf') }}",
            detailUrl: "{{ route('akademik.data-wisudawan.show', ':id') }}",
            verifyUrl: "{{ route('akademik.data-wisudawan.verify', ':id') }}",
    ...
    @vite('resources/js/akademik/data-wisudawan/index.js')
@endpush
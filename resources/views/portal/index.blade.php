    ...
    <section
        ...
        <div class="relative z-10 w-[100%] max-w-4xl text-left animate-fadeIn">
            ...
            <button onclick="window.location.href='/mahasiswa'"
                class="mt-4 flex items-center gap-2 bg-green-500 px-6 py-3 rounded-lg text-white font-semibold hover:bg-green-600 hover:scale-105 transition-all duration-300 shadow-lg shadow-green-500/30">

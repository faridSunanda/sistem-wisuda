...
@section('content')
    <div class="space-y-4 md:space-y-6 pb-10">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Data Group</h1>
            <a href="{{ route('admin.master.group.create') }}"
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
            <div class="p-6 border-b border-gray-100">
                <h2 class="text-lg font-semibold text-gray-900">Daftar Group Wisuda</h2>
            </div>
            <div class="p-6">
                <table id="groupTable" class="w-full">
                    <thead>
...
@push('styles')
    ...
    @vite('resources/css/admin/group.css')
@endpush

@push('scripts')
    <script>
        window.groupConfig = {
            getDataUrl: "{{ route('admin.master.group.get-data') }}",
            exportUrl: "{{ route('admin.master.group.export') }}",
            exportExcelUrl: "{{ route('admin.master.group.export-excel') }}",
            exportPdfUrl: "{{ route('admin.master.group.export-pdf') }}",
            detailUrl: "{{ route('admin.master.group.show', ':id') }}",
            editUrl: "{{ route('admin.master.group.edit', ':id') }}",
            deleteUrl: "{{ route('admin.master.group.destroy', ':id') }}",
    ...
    @vite('resources/js/admin/master/group/index.js')
@endpush

...
@section('content')
    <div class="space-y-4 md:space-y-6 pb-10">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('admin.master.alur-pendaftaran.create') }}"
...
@push('scripts')
    <script>
        window.alurPendaftaranConfig = {
            getDataUrl: "{{ route('admin.master.alur-pendaftaran.get-data') }}",
            exportUrl: "{{ route('admin.master.alur-pendaftaran.export') }}",
            exportExcelUrl: "{{ route('admin.master.alur-pendaftaran.export-excel') }}",
            exportPdfUrl: "{{ route('admin.master.alur-pendaftaran.export-pdf') }}",
            detailUrl: "{{ route('admin.master.alur-pendaftaran.show', ':id') }}",
            editUrl: "{{ route('admin.master.alur-pendaftaran.edit', ':id') }}",
            deleteUrl: "{{ route('admin.master.alur-pendaftaran.destroy', ':id') }}",
    ...
    @vite('resources/js/admin/master/alur-pendaftaran/index.js')
@endpush

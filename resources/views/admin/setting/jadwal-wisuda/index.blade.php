...
@section('content')
    <div class="space-y-4 md:space-y-6 pb-10">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('admin.setting.jadwal-wisuda.create') }}"
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            <div class="p-6 border-b border-gray-100">
                <h2 class="text-lg font-semibold text-gray-900">Daftar Jadwal Wisuda</h2>
            </div>
            <div class="p-6">
                <table id="jadwalWisudaTable" class="w-full">
                    <thead>
                        <tr class="bg-gray-50">

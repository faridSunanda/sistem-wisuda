...
@section('content')
    <div class="space-y-4 md:space-y-6 pb-10">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
            <form action="{{ route('admin.setting.dokumen-persyaratan.update', $dokumen->id) }}" method="POST"
                    ...
                    <div class="md:col-span-2">
                        ...
                        @if ($dokumen->berkas)
                            <div class="mt-2 p-3 bg-gray-50 rounded-lg">
                                <p class="text-sm text-gray-600">Berkas saat ini:</p>
                                <a href="{{ asset('storage/' . $dokumen->berkas) }}" target="_blank"
                                    class="text-[#435ebe] hover:underline text-sm">
                                    {{ $dokumen->berkas }}
                                </a>
                            </div>
                        @endif

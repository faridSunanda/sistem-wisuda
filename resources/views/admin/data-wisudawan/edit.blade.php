        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
            <form action="{{ route('admin.data-wisudawan.update', $user->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                    <div>
                        ...
                        <input type="text" id="name_lengkap" name="name_lengkap"
                            value="{{ old('name_lengkap', $user->name_lengkap) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" id="nim" name="nim"
                            value="{{ old('nim', $user->biodata->nim ?? '') }}"
                            class="w-full px-4 py-2.5 text-sm bg-gray-50 border-0 rounded-lg text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all">
                    </div>
                    <div>
                        ...
                        <input type="number" id="tahun_masuk" name="tahun_masuk"
                            value="{{ old('tahun_masuk', $user->biodata->tahun_masuk ?? '') }}"
                            class="w-full px-4 py-2.5 text-sm bg-gray-50 border-0 rounded-lg text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all">
                    </div>
                    <div>
                        ...
                        <input type="text" id="fakultas" name="fakultas"
                            value="{{ old('fakultas', $user->biodata->fakultas ?? '') }}"
                            class="w-full px-4 py-2.5 text-sm bg-gray-50 border-0 rounded-lg text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all">
                    </div>
                    <div>
                        <label for="program_studi" class="block text-sm font-normal text-gray-600 mb-1.5">Program
                            Studi</label>
                        <input type="text" id="program_studi" name="program_studi"
                            value="{{ old('program_studi', $user->biodata->program_studi ?? '') }}"
                            class="w-full px-4 py-2.5 text-sm bg-gray-50 border-0 rounded-lg text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all">
                    </div>
                </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-300 flex gap-3">
                    ...
                    <a href="{{ route('admin.data-wisudawan.index', $user->id) }}"

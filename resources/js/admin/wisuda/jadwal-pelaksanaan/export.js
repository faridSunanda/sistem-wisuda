    ...
    function handleExport($btn, exportType, callback) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const headers = ['No', 'Nama Kegiatan', 'Sesi', 'Waktu Pelaksanaan', 'Tanggal Pelaksanaan', 'Tempat Pelaksanaan', 'Keterangan'];
        ...
        handleExport($btn, 'print', function(headers, data) {
            try {
                ...
                let html = `
                    ...
                    <html>
                    <head>
                        <title>Jadwal Pelaksanaan Wisuda</title>
                        <style>
                    ...
                    <body>
                        <h1>Jadwal Pelaksanaan Wisuda</h1>
                        <table>
                            <thead>
                                <tr>

    ...
    function handleExport($btn, exportType, callback) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const headers = ['No', 'Nama Kegiatan', 'Waktu Pelaksanaan', 'Tempat', 'Keterangan'];
            ...
            error: function(xhr, status, error) {
                ...
                let errorMsg = 'Terjadi kesalahan saat mengambil data jadwal wisuda.';

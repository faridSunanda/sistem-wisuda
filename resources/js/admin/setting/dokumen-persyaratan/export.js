    ...
    $(exportExcelBtn).on('click', function() {
        ...
        handleExport($btn, 'excel', function(headers, data) {
            try {
                ...
                XLSX.utils.book_append_sheet(wb, ws, 'Dokumen Persyaratan');

                const fileName = 'Dokumen_Persyaratan_' + new Date().toISOString().split('T')[0] + '.xlsx';
    ...
    $(exportPdfBtn).on('click', function() {
        ...
        handleExport($btn, 'pdf', function(headers, data) {
            try {
                ...
                doc.setFontSize(16);
                doc.text('Data Dokumen Persyaratan', 14, 15);
                ...
                const fileName = 'Dokumen_Persyaratan_' + new Date().toISOString().split('T')[0] + '.pdf';
                doc.save(fileName);
            } catch (error) {

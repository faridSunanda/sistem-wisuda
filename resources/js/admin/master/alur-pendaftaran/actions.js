export function initActions(config) {
    ...
    window.lihatData = function(id) {
        if (detailUrl) {
            ...
            window.location.href = `/admin/master/alur-pendaftaran/${id}`;
        }
    };
    ...
    window.editData = function(id) {
        if (editUrl) {
            ...
            window.location.href = `/admin/master/alur-pendaftaran/${id}/edit`;
        }
    };
    ...
    window.hapusData = function (id, buttonEl) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const url = deleteUrl ? deleteUrl.replace(':id', id) : `/admin/master/alur-pendaftaran/${id}`;

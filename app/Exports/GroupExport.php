...
class GroupExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, WithColumnWidths, WithEvents
{
    protected $data;
    ...
    protected function addTitleAndDate(Worksheet $sheet): void
    {
        ...
        $sheet->setCellValue('A1', 'Laporan Data Group');
